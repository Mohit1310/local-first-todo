	...
	return (
		<div className="flex items-center justify-between rounded-sm border p-1 group/input hover:bg-accent">
			...
			<div className="flex items-center gap-0.5 group-hover/input:opacity-100 opacity-0">
				<button
					type="button"
					className="rounded-xs p-1.5 text-primary hover:bg-primary/40 flex items-center justify-center"
				...
				<button
					type="button"
					className="rounded-xs p-1.5 text-destructive hover:bg-destructive/40"
				>
					<X className="size-4" />
				</button>
			</div>
